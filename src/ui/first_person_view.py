...
from PyQt6.QtGui import QPainter, QLinearGradient, QPainterPath, QColor, QBrush, QPen, QFont
import math
...
class FirstPersonView(QGraphicsView):
    ...
    def render_view(self):
        ...
        if dist_to_exit < 1.5:
            ...
            prompt_text = self.scene().addText("🚪 按 E 进入下一关", QFont("Arial", 24))
            prompt_text.setDefaultTextColor(QColor(255, 255, 100))
            prompt_text.setPos(300, 400)
